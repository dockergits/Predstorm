...
$apiKey = 'cTql6UDMLyWA7tKPqic349SlF7lilPAexllc28xGjKvB7i3WbpjMWyhO4FjxjT';
$offer_id = 12045; // для каждого оффера свой айди, надо уточнять его в админке или у суппортов
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $data = array(
            ...
            'country' => MX, // формат ISO 3166-1 Alpha-2 - https://ru.wikipedia.org/wiki/ISO_3166-1
...
header("Location: success.html?com=".$_POST['com']."&name=".urlencode($name)."&phone=".urlencode($phone));
    if (null === $obj) {
